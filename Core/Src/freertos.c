...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of OLED */
  OLEDHandle = osThreadNew(iicTask, NULL, &OLED_attributes);
...
/* USER CODE BEGIN Header_iicTask */
/**
* @brief Function implementing the OLED thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_iicTask */
void iicTask(void *argument)
{
  /* USER CODE BEGIN iicTask */
  AppDisplay_Task(argument);
  /* USER CODE END iicTask */
}
